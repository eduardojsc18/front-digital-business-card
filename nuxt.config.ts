    ...
    app: {
        head: {
            ...
            meta: [
                ...
                {property: 'og:image:secure_url', content: 'https://fisioerikaqueiroz.vercel.app/img/dra-erika-queiroz-fisioterapeuta-especialista-ortopedista-pilates-guarulhos.jpg'},
                {property: 'og:image:type', content: 'image/jpeg'},
                {property: 'og:image:height', content: '400'},
                {property: 'og:image:width', content: '200'},
                {property: "og:image", content: 'https://fisioerikaqueiroz.vercel.app/img/dra-erika-queiroz-fisioterapeuta-especialista-ortopedista-pilates-guarulhos.jpg?w=400&amp;h=200'},
                {property: 'og:image:type', content: 'image/jpeg'},
                {property: 'og:image:height', content: '1280'},
                {property: 'og:image:width', content: '640'},
                {property: "og:image", content: 'https://fisioerikaqueiroz.vercel.app/img/dra-erika-queiroz-fisioterapeuta-especialista-ortopedista-pilates-guarulhos.jpg?w=1280&amp;h=640'},
                ...
                {property: "twitter:image", content: 'https://fisioerikaqueiroz.vercel.app/img/dra-erika-queiroz-fisioterapeuta-especialista-ortopedista-pilates-guarulhos.jpg'},
            ],
            script: [
